...
public class positiveandnegative extends BaseClass {
	...
	@When("To move to the login button")
	public void to_move_to_the_login_button() {
	...
	public void to_pass_valid_useridin_in_number_field(String em) throws InterruptedException {
		Thread.sleep(3000);
